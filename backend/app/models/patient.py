...
class Patient(Base):
    ...
    emergency contacts, and location data.
    """
    ...
    emergency_requests = relationship(
        "EmergencyRequest", back_populates="patient", lazy="dynamic"
    )
    medical_reports = relationship(
        "MedicalReport", back_populates="patient", lazy="dynamic"
    )
    predictions = relationship(
        "Prediction", back_populates="patient", lazy="dynamic"
    )
